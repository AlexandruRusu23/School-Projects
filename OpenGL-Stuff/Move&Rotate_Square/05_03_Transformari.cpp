...
void Initialize(void)
{
	...
	matrTransl[0][0]=1; matrTransl[0][1]=0; matrTransl[0][2]=0; matrTransl[0][3]=0;
	...
	matrRot[0][0]=1; matrRot[0][1]=0; matrRot[0][2]=0; matrRot[0][3]=0;
	matrRot[1][0]=0; matrRot[1][1]=1; matrRot[1][2]=0; matrRot[1][3]=0;
...
void Keyboard(unsigned char key, int x, int y)
{
		switch(key)
		{
			...
			break;
			case 'r':
				float sus = matrTransl[1][3];
				float jos = matrTransl[0][3]; 
				matrTransl[1][3] = 0;
				matrTransl[0][3] = 0;
				matrRot[0][0] = cos(PI/4.0f);
				matrRot[0][1] = -sin(PI/4.0f);
				matrRot[1][0] = sin(PI/4.0f);
				matrRot[1][1] = cos(PI/4.0f);
				glutPostRedisplay();
				matrTransl[1][3] = sus;
				matrTransl[0][3] = jos;
				glutPostRedisplay();
