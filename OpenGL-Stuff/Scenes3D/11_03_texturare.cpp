...
void CreateVBO(void)
{
  ...
  GLfloat Vertices[] = {
     ...
     50.0f,  -50.0f, 0.0f, 1.0f,   0.0f, 1.0f, 0.0f,	3.0f, 0.0f,  // dreapta jos
	 50.0f,  50.0f, 0.0f, 1.0f,    1.0f, 1.0f, 0.0f,	3.0f, 3.0f, // dreapta sus
	 -50.0f,  50.0f, 0.0f, 1.0f,   0.0f, 1.0f, 1.0f,	0.0f, 3.0f  // stanga sus
  };
