 ...
 * @author Alexandru
 */
@WebServlet(name = "modifyContact", urlPatterns = {"/modifyContact"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!"".equals(id))
        {
                ...
                try
                {
                    ...
                    String update = "update onlineagenda.contacts set ";
                    ...
                    {
                        if(cont > 1)
                            update = update + ", phonenumber ='" + mobilePhone +"' ";
                        else
                            update = update + " phonenumber = '" + mobilePhone +"' ";
                        cont ++;
                    }
                    ...
                    {
                        if(cont > 1)
                            update = update + ", fixnumber ='" + fixPhone +"' ";
                        else
                            update = update + " fixnumber = '" + fixPhone +"' ";
                        cont ++;
                    }
                    ...
                    if(cont > 1)
                    {
                        update = update + "where acctNum ='" + id +"'; ";
        ...
        if(check == false)
        {
            out.println("<h1> Contact NOT modified!</h1>");
        }
        else
        {
            out.println("<h1>Contact modified!</h1>");
            out.println("<p>You modified " + firstName + " " + surname + "</p>");
        }
        
        out.println("<a href =\"index.html\"> HOME </a> <br><br>");
        out.println("<a href =\"modifyContact.html\"> Modify another contact </a> <br><br>");
        out.println("</body>");
        out.println("</html>");
